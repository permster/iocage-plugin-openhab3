...
mkdir -p ${INSTALL_DIR} /config/persistence/db4o /config/persistence/rrd4j /config/persistence/mapdb /config/backups /config/home /config/userdata/etc/scripts /config/userdata/tmp /config/etc/openhab3
...
rm ${INSTALL_DIR}/*.ps1 ${INSTALL_DIR}/*.bat ${INSTALL_DIR}/runtime/bin/*.ps1 ${INSTALL_DIR}/runtime/bin/*.bat \
...
# patch setenv
# cp ${INSTALL_DIR}/runtime/bin/setenv ${INSTALL_DIR}/runtime/bin/setenv.orig
cd ${INSTALL_DIR}/runtime/bin/
patch < ${dir}/patch-runtime_bin_setenv
